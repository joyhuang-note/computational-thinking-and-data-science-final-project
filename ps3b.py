...
def simulationWithoutDrug(numViruses, maxPop, maxBirthProb, clearProb,
    ...
    for step in range(timesteps):
        simulation.append([]) # trials of total population in certain step
    ...
    for trial in range(numTrials):
        ...
        for step in range(timesteps):
            simulation[step].append(patient.update())

    # calculate the average size of the virus population
    averagePopulation = [];

    for step in range(timesteps):
        averagePopulation.append(sum(simulation[step]) / float(numTrials));

    pylab.plot(range(timesteps), averagePopulation, label="SimpleVirus")
    pylab.title("SimpleVirus simulation")
    pylab.xlabel("Timestep")
    pylab.ylabel("Average size of the virus Population")
    pylab.legend(loc='upper left')
    #pylab.savefig('simpleVirus-simulation.png')
    pylab.show()
...
class TreatedPatient(Patient):
    ...
    def __init__(self, viruses, maxPop):
        ...
        self.viruses = viruses
        self.maxPop = maxPop
        self.postcondition = [] # used drug list
    ...
    def getResistPop(self, drugResist):
        ...
        return len(filter(f, self.viruses))
...
"""
Uncomment following lines to execute PROBLEM 2
"""
#simulationWithoutDrug(100, 1000, 0.1, 0.05, 100)

"""
Uncomment following lines to execute PROBLEM 4
"""
